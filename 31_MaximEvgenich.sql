...
select min(id) AS "Минимальный id" from students s; 
-- 29. Вывести максимальный. --
select max(id) AS "Максимальный id" from students s; 
-- 30. Вывести количество пользователей --
select count(id) AS "Количество пользователей" from students s; 
